...
const Clasificacion = () => {
  ...
  return (
    <section className={styles.standings} id="clasificación">
      <div className={styles.standings__inner}>
        <header className={styles.standings__header}>
          <div className={styles.standings__subtitle}>
            <div className={styles.standings__subtitleIcon} />
            <span className={styles.standings__status}>
              {standings.season}
            </span>
          </div>
          <h2 className={styles.standings__title}>Clasifiación</h2>
        </header>
